...
console.log(sql4Stmt)
const expt4Stmt = "SELECT * FROM `Employee` LIMIT ? OFFSET ?;"
console.assert(sql4Stmt === expt4Stmt, '❌ sql4Stmt is not as expected')
const sql4Binders = sql4.getBindValues()
console.log(sql4Binders)
const expt4Binders = [50, 10]
console.assert(JSON.stringify(sql4.getBindValues()) === JSON.stringify(expt4Binders), '❌ sql4Stmt.getBindValues() is not as expected')

const sql5 = sql.selectAsteriskFrom(Employee).limit$(10, 50)
const sql5Stmt = sql5.getSQL()
console.log(sql5Stmt)
const expt5Stmt = "SELECT * FROM `Employee` LIMIT ?, ?;"
console.assert(sql5Stmt === expt5Stmt, '❌ sql5Stmt is not as expected')
const sql5Binders = sql5.getBindValues()
console.log(sql5Binders)
const expt5Binders = [10, 50]
console.assert(JSON.stringify(sql5.getBindValues()) === JSON.stringify(expt5Binders), '❌ sql5Stmt.getBindValues() is not as expected')
